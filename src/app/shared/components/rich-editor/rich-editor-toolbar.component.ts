...
@Component({
	selector: "rich-editor-toolbar",
	templateUrl: "./rich-editor-toolbar.component.html",
	styleUrls: ["./rich-editor-toolbar.component.scss"]
})
export class RichEditorToolbarComponent {
	id = "";
	htmlMode = false;
	showToolbar = true;
	...
	triggerButtons() {
		...
		this.buttons.forEach(e => {
			...
			const elementById = this._document.getElementById(
				e + "-" + this.id
			);
			if (result) {
