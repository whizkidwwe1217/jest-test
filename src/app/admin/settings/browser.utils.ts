export class BrowserUtils {
	public static buildRules(ruleTuples) {
	...
	public static getOperatingSystemRules() {
	...
	public static detectOS(userAgentString) {
		let rules = this.getOperatingSystemRules();
	...
	public static parseUserAgent(userAgentString) {
		let browsers = this.getBrowserRules();
		if (!userAgentString) {
			return null;
		}
