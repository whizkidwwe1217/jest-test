...
import { HfDynamicWrapper } from "./hf-dynamic-wrapper";
 ...
 */
export class HfHostWrapper<W extends HfDynamicWrapper> implements Injector {
  constructor(containerType: Type<W>, vcr: ViewContainerRef, index: number = 0) {
    ...
    if (!this.injector.get(containerType, null)) {
      ...
      vcr.createComponent(cfr.resolveComponentFactory(HfEmptyAnchor));
