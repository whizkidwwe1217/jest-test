...
import { HfYearRangeModel } from "./model/hf-year-range.model";
import { UP_ARROW, DOWN_ARROW, RIGHT_ARROW, LEFT_ARROW } from "../../clr-utils/key-codes";

@Component({
  selector: "hf-yearpicker",
  ...
  template: `
    <div class="year-switchers">
      ...
      >
        <clr-icon
          shape="event"
          [attr.title]="commonStrings.keys.datepickerCurrentDecade"
        ></clr-icon>
      </button>
      <button
        class="calendar-btn switcher"
      ...
      >
        <clr-icon
          shape="angle"
          dir="right"
          [attr.title]="commonStrings.keys.datepickerNextDecade"
        ></clr-icon>
      </button>
    </div>
    <div class="years">
...
export class HfYearpicker implements AfterViewInit {
  constructor(
    ...
    this.yearRangeModel = new HfYearRangeModel(this.calendarYear);
   ...
   */
  yearRangeModel: HfYearRangeModel;
  ...
  private updateRange(yrm: HfYearRangeModel): void {
