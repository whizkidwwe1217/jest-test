...
import { HfCheckboxWrapper, IS_TOGGLE } from "./hf-checkbox-wrapper";
 ...
 */
@Directive({ selector: "[hfCheckbox],[hfToggle]" })
export class HfCheckbox extends HfWrappedFormControl<HfCheckboxWrapper> {
  constructor(
    ...
    super(vcr, HfCheckboxWrapper, injector, control, renderer, el);
  }
